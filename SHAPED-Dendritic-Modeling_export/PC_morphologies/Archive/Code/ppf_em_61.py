...
# Variables
max_EM_iterations = 2  # maximum number of iterations for EM algorithm
...
#        lamb_tmp2 = [x*coef1 for x in lamb_tmp2]
...
#                            lamb_tmp2[j:j+L] *= refract
            ...
            if poisson_sum < 1 or poisson_sum > 10:
                p_flag = 1
            else:
                p_flag = 1
...
def conditional_probability(index, conditions):
    conditionals_file = '\Users\Zane\Desktop\Morphologies\Codes\claiborne_conditionals.txt'   
...
#                            break
                    ...
                    bif_amp = conditional_probability(5, branch.pathlength_from_soma)
...
#                print branch.pathlength_from_soma - branch.pathlength
    ...
    #        print sholl_error
            ...
            if len(b_list) < 20 or len(b_list) > 48:
                flag = flag_val

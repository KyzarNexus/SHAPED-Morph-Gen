...
def part_1(n, part1_flag):
    ...
    if part1_flag == 1:
        ...
        # filtered_keys = pickle.load(pickle_in); keys = filtered_keys
        keys = [(0.9,0.1,1,-13)]
        # keys = [(0.3,0.5,-2,-5)]
        ...
        pickle_out = open('lambPic_granule.pickle','wb')
...
file_pp = '..\\..\\Data\\Metrics\\claiborne_point_process.txt'

file_con = '..\\..\\Data\\Metrics\\claiborne_conditionals.txt'
...
raster_flag = 1     # visualizes loaded point process data into a raster plot
...
part_1(n,part1_flag)
part_2(n,part2_flag)
# output = part_3(file_con,part3_flag,'granule')

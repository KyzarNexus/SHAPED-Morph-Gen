...
file_name = '../Data/Metrics/amaral_point_process.txt'
file_name_apical =  '../Data/Metrics/amaral_point_process_apical.txt'
file_name_basal = '../Data/Metrics/amaral_point_process_basal.txt'

n = read_file(file_name_apical)
max_N = len(n[0])
max_R = len(n)
...
file_name_pp = '../Data/Metrics/amaral_point_process_apical.txt'

...
#        f.write(strs + '\n')
        ...
        line = (compartment.compartment_id, 1, compartment.end_coordinates[0], compartment.end_coordinates[2], compartment.end_coordinates[1], compartment.diameter/2, -1)
        strs=' '.join(str(x) for x in line)
        f.write(strs + '\n')  
        c_id = c_id + 1
        old_x_jitter = 0
...
#                        print old_x_jitter + jitter_counter*x_jitter, x_jitter
                        line = (compartment.compartment_id, 3, compartment.end_coordinates[0]*major_scale + old_x_jitter + jitter_counter*x_jitter, compartment.end_coordinates[2], compartment.end_coordinates[1]*minor_scale + old_z_jitter + jitter_counter*z_jitter, compartment.diameter/2, parent_id)
                        strs=' '.join(str(x) for x in line)
                        f.write(strs + '\n')
                        jitter_counter = jitter_counter + 1

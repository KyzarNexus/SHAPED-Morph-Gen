...
np.random.seed(8675309); random.seed(8675309) # Dual seeds due to both in-built and package random functions being used. 
...
file_name = '..\\..\\Data\\Metrics\\claiborne_point_process.txt'
...
if part1_flag == 1:
    ...
    for ii in range(max_EM_iterations):
        ...
        # rho_new = 0.993   # WHAT THE HELL? Why is this being reset to a constant? (4-8-21)
        # mu_new = -11.09
        ...
        var_0_new = state_variance_new/(1-rho_new**2)
    print('Final Parameters: {},{},{},{}'.format(rho_new, state_variance_new, beta_new, mu_new)) 
    ...
    # Temporary Saving of lambda in a dict pickle file to analyse elsewhere
    lambDict = {}; lambDict[tuple([rho_new,state_variance_new,beta_new,mu_new])] = lamb2

    with open('lambPic.pickle','wb') as f: # Saving Rate Estimates
        pickle.dump(lambDict,f)
